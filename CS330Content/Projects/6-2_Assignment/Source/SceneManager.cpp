...
void SceneManager::DefineObjectMaterials()
{
	...
	light1.ambientColor = glm::vec3(0.3f, 0.1f, 0.8f);
	light1.ambientStrength = 0.5f;
	light1.diffuseColor = glm::vec3(0.3f, 0.1f, 0.4f);
	light1.specularColor = glm::vec3(0.3f, 0.1f, 0.2f);
	...
	light2.ambientColor = glm::vec3(0.2f, 0.2f, 0.2f);
	light2.ambientStrength = 0.1f;
	light2.diffuseColor = glm::vec3(0.3f, 0.3f, 0.3f);
	light2.specularColor = glm::vec3(0.1f, 0.1f, 0.1f);
	light2.shininess = 5.0;
	light2.tag = "light2";
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.3f, 0.1f, 0.8f);
	m_pShaderManager->setVec3Value("lightSources[0].diffuseColor", 0.1f, 0.1f, 0.6f);
	m_pShaderManager->setVec3Value("lightSources[0].specularColor", 0.9f, 0.2f, 0.2f);
	...
	m_pShaderManager->setVec3Value("lightSources[1].position", 0.0f, 0.0f, -5.0f);
...
void SceneManager::RenderScene()
{
	...
	/*****************           LIGHT SOURCE 1    (colored)      ***************/
	// a transparent sphere is used for the first light source for projecting light onto the scene. 
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.0f, 1.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(3.0f, 2.0f, 5.0f);
	...
	/*****************           LIGHT SOURCE 2         ***************/
	// a transparent sphere is used for the second light source for projecting light onto the scene. 
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.0f, 1.0f, 1.0f);
